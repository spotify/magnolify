...
val bigqueryVersion = "v2-rev20250511-2.0.0"
...
ThisBuild / mimaBinaryIssueFilters ++= Seq(
  ...
  ProblemFilters.exclude[DirectMissingMethodProblem]("magnolify.parquet.MagnolifyParquetProperties.WriteAvroCompatibleArrays")
)
