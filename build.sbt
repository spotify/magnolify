...
lazy val refined = project
  ...
  .dependsOn(
    ...
    guava % "compile->compile,provided;test->test",
    protobuf % "compile->compile,provided;test->test",
...
lazy val site: Project = project
  ...
  .settings(
    Laika / sourceDirectories += sourceDirectory.value / "laika",
    libraryDependencies ++= Seq(
    ...
    laikaTheme := siteTheme.value,
    laikaExtensions := siteExtensions
  )
