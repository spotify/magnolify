...
| `java.time.Instant`               | `long`<sup>11</sup>          | `ROW`<sup>17</sup>                      | `TIMESTAMP`           | x                               | `Timestamp`           | `LOGICAL[TIMESTAMP]`<sup>9</sup>  | x                       | x                   |
...
| `org.joda.time.DateTime`          | `int`<sup>11</sup>           | `ROW`<sup>17</sup>                      | x                     | x                               | x                     | x                                 | x                       | x                   |
